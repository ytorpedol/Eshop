<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="dmap.aspx.cs" Inherits="EShop.dmap" %>
<!DOCTYPE HTML>
<html>
<head>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
 <script type="text/javascript" src="https://cache.amap.com/lbs/static/es5.min.js"></script>
    <script type="text/javascript"="https://webapi.amap.com/maps?v=1.4.10&key=d8a049e578904edb68c128c04449f9f2"></script>
    <script type="text/javascript" src="https://cache.amap.com/lbs/static/addToolbar.js"></script>
<title>3D覆盖物的添加与移除地图</title>
<style>
